...
import { doc, addDoc, serverTimestamp, collection, onSnapshot } from "firebase/firestore";
...
export default function NewPage() {
    ...
    useEffect(() => {
        ...
        const unsubscribeCategories = onSnapshot(settingsDocRef, (doc) => {
            if(doc.exists()) {
                const categories = doc.data().pageCategories || [];
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Add a new informational or policy page to your website.</CardDescription>
                </CardHeader>
                 <form onSubmit={form.handleSubmit(onSubmit)}>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                             ...
                             <Textarea id="content" {...form.register("content")} rows={15} placeholder="Write your page content here. Basic HTML is supported."/>
                        ...
                        <div className="flex justify-end pt-4">
                             <Button type="submit" disabled={isSubmitting}>
                                ...
                                <Save className="mr-2" /> Create Page
                            </Button>
                        </div>
                    </CardContent>
                </form>
