    ...
    try {
        ...
        try {
            ...
            if (error.code === 'auth/user-not-found') {
              ...
              throw error; // Re-throw other auth errors to be caught by the client
            }
        }

        // 3. Delete all related Firestore documents
        ...
        // 4. Delete all subcollections inside the user document
